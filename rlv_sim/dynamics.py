...
def compute_state_derivative(r: np.ndarray, v: np.ndarray, q: np.ndarray,
                             ...
                             dry_mass: float = None, stage: int = 1) -> StateDerivative:
    """
    ...
    r_dot = v
    v_dot = compute_linear_acceleration(r, v, q, m, thrust_on, throttle, stage=stage)
...
def state_derivative_vector(state_vec: np.ndarray, t: float,
                           ...
                           dry_mass: float = None, stage: int = 1) -> np.ndarray:
    """
